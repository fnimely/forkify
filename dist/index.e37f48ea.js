...
const controllAddRecipe = async function(newRecipe) {
    try {
        ...
        _recipeViewJsDefault.default.render(_modelJs.state.recipe);
        // success message
        _addRecipeViewDefault.default.renderMsg();
...
const init = function() {
    _bookmarksViewJsDefault.default.addHandlerRender(controllBookmarks);
    _recipeViewJsDefault.default.addHandlerRender(controlRecipes);
    _recipeViewJsDefault.default.addHandlerUpdateServings(controlServings);
    _recipeViewJsDefault.default.addHandlerAddBookmark(controllAddBookmark);
    ...
    _addRecipeViewDefault.default._addHandlerUpload(controllAddRecipe);
};
init();

},{"core-js/modules/web.immediate.js":"49tUX","./model.js":"Y4A21","./config.js":"k5Hzs","./views/recipeView.js":"l60JC","./views/searchView.js":"9OQAM","./views/resultsView.js":"cSbZE","./views/paginationView.js":"6z7bi","./views/bookmarksView.js":"4Lqzq","./views/addRecipeView":"i6DNj","regenerator-runtime/runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
...
const KEY = `56d906a4-388f-4553-a585-d1b10a00e425`;
    ...
    _generateMarkup() {
      ...
      <div class="recipe__details">
        ...
        <div class="recipe__info">
          ...
          <svg class="">
            <use href="${_iconsSvgDefault.default}#icon-bookmark${this._data.bookmarked ? '-fill' : ''}">
            </use>
          </svg>
        </button>
      </div>
...
var _iconsSvg = require("url:../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
class ResultsViewv extends _viewJsDefault.default {
...
exports.default = new ResultsViewv();
...
class PaginationView extends _viewJsDefault.default {
    ...
    `;
        ...
        if (currPage === 1 && numPages > 1) return rightBtn;
        // last page
        if (currPage === numPages && numPages > 1) return leftBtn;
        // other page
        if (currPage < numPages) return leftBtn.concat(rightBtn);
        return '';
    }
}
...
class AddRecipeView extends _viewJsDefault.default {
    ...
    _addHandlerUpload(handler) {
        this._parentElement.addEventListener('submit', function(e) {
            e.preventDefault();
            //   FormatData gets all value from a form
            const dataArr = [
                ...new FormData(this)
            ];
